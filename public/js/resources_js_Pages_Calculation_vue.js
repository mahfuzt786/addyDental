...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapActions)(['calculateValuesApi' // 'getStatusImport'
    ...
    displayData: function displayData(responseData) {
      ...
      this.dataRV_GAV_AAV = [];
      this.overlay = false; //('Aufbaufüllung_RV') reset
    ...
    cancelPlanen: function cancelPlanen(rowIndex) {
      ...
      this.optGozGavCall_(rowIndex); // stift reset
    ...
    totalTableCalc: function totalTableCalc() {
      // Final calc before display in the table
    ...
    displayOptsBemaRV: function displayOptsBemaRV(rowIndex) {
      if (this.optBemaRV[rowIndex] == 'yes') {
        ...
        this.optBemaRVSecond[rowIndex] = false; // reset stift
    ...
    weiterCallFlabCalc: function weiterCallFlabCalc() {
      ...
      this.totalBemaDispZusa.forEach(function (values) {
        ...
        totalBemaDispZusaArr[values.value]['region'] = typeof totalBemaDispZusaArr[values.value]['region'] !== 'undefined' && totalBemaDispZusaArr[values.value]['region'] != null // && (totalBemaDispZusaArr[values.value]['region'] !== values.region)
      ...
      this.totalGavDispZusa.forEach(function (values) {
        ...
        totalGozDispZusaArr[values.value]['region'] = typeof totalGozDispZusaArr[values.value]['region'] !== 'undefined' && totalGozDispZusaArr[values.value]['region'] != null // && (totalGozDispZusaArr[values.value]['region'] !== values.region)
