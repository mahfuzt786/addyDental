...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapActions)(['calculateValuesApi' // 'getStatusImport'
      ...
      if ((this.rules.validEntry(this.findingsEntries) || this.errorMsg) && (this.findingsEntries || !this.invalidEntries)) {
        ...
        this.calculateValuesApi(input).then(function (response) {
          ...
          if (response.data.length > 1) {
            ...
            var title_UK = '';
            var text_UK = '';
            var condition = ['"f"', '"x"', '"ew"', '"bw"', '"kx"', '"swfb"']; // if(response.data[1][0]['Case Region'] == 'OK')
            ...
            if (response.data[1]['Final'][0]['region'] == 'UK') {
              ...
              if (condition.includes(JSON.stringify(input[16][38])) && condition.includes(JSON.stringify(input[17][37])) && condition.includes(JSON.stringify(input[31][48])) && condition.includes(JSON.stringify(input[30][47]))) {
    ...
    displayRVs: function displayRVs(label, idValue, ids, caseId) {
      var dataValues = JSON.parse(document.getElementById(idValue).value); // console.log(dataValues['GAV Solution shortcuts'])
    ...
    calculateFindingsImport: function calculateFindingsImport() {
      ...
      for (var _i = 0; _i < findingsArrayImportIni.length; _i++) {
        ...
        _char2 = findingsArrayImportIni[_i].match(/[a-z)(\-]/g);
    ...
    optRVBemaActivate: function optRVBemaActivate() {
    ...
    totalTableCalc: function totalTableCalc() {
    ...
    calcTable: function calcTable(dialogRowIndex) {
      ...
      var clsGozAmount = 0;
      var clsBemaAmount = 0; // FOR DELETE

      this.totalBema = 0;
      this.totalAmountF = 0;
      this.totalGav = 0;
      this.totalSumCalc = 0; // END FOR DELETE
      ...
      this.showCaseTrash = true; // this.showCaseTrash.push(dialogRowInde                    x)

      this.showCasePencil.push(dialogRowIndex); // document.getElementById("planen"+dialogRowIndex).setAttribute("disabled", "disabled");
      // remove duplicates from the showCase Trash, showCasePencil array
      // this.showCaseTrash = [...new Set(this.showCaseTrash)]

      var filteredArray = _toConsumableArray(new Set(this.showCasePencil));
