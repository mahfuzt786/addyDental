...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      showOptGozGAVTable_RV: [],
      // opt GOZ GAV op 1
      showOptGozGAV_Table_RV: [],
      // opt GOZ GAV op 2
      ...
      showOptGozGAVTable_GAV: [],
      // opt GOZ GAV op 1
      showOptGozGAV_Table_GAV: [],
      // opt GOZ GAV op 2
  ...
  computed: {
    ...
    totalAmount: function totalAmount() {
      ...
      if (this.tableData['Final'] && this.tableData['Final'].length > 0) {
        ...
        }, 0) / this.tableData['Total_case']).toFixed(2);
      } else {
        return '0.00';
      }
    },
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapActions)(['calculateValuesApi' // 'getStatusImport'
    ...
    displayData: function displayData(responseData) {
      ...
      this.dataRV_GAV_AAV = [];
      this.overlay = false; //('Aufbaufüllung_RV')
    ...
    optGozGavCall: function optGozGavCall(solNo) {
      ...
      console.log('solNo');
      console.log(this.OptGozGAVselected_RV);
      console.log(this.OptGozGAVselected_RV_); // console.log(document.getElementById("Aufbaufüllung_RV"+solNo).checked)

      console.log('solNo__'); // if(document.getElementById("Aufbaufüllung_RV"+solNo).checked == true) {
    ...
    optGozGavCall_: function optGozGavCall_(solNo) {
      console.log(solNo);
      console.log(this.OptGozGAVselected_RV_); // if(this.OptGozGAVselected_RV[solNo] == "Aufbaufüllung_RV"+solNo
      // ) {
      //   this.displayOptGozGavs_RV[solNo] = true
      // }
      // else {
    ...
    optGozGavCallReg: function optGozGavCallReg(dialogRow, region) {
    ...
    cancelPlanen: function cancelPlanen(rowIndex) {
      ...
      this.totalTableCalc(); // reset opt checkboxes
    ...
    calcTable: function calcTable(dialogRowIndex) {
      ...
      this.showCaseTrash = true; // this.showCaseTrash.push(dialogRowIndex)

      this.showCasePencil.push(dialogRowIndex); // remove duplicates from the showCase Trash, showCasePencil array
    ...
    displayOptsBemaRV: function displayOptsBemaRV(rowIndex) {
      if (this.optBemaRV[rowIndex] == 'yes') {
        this.optBemaRVSecond[rowIndex] = true;
      } else {
        this.optBemaRVSecond[rowIndex] = false; // this.optBemaRVSecond2[region] = false
