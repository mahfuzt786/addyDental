  ...
  <div class="home-page mx-8 my-4">
    ...
    <div class="ma-auto" style="max-width: min-content">
      ...
      <div class="reset-btn">
        ...
        <!-- <router-link v-if="!isLoggedIn" to="/"> {{ isLoggedIn }} </router-link> -->
      ...
      <div v-if="calculated" class="my-4">
        ...
        <v-simple-table outlined class="my-2">
          <template v-slot:default>
            <thead>
              <tr>
                <th class="text-center text-subtitle-1 font-weight-black">Befund-Nr.</th>
                <th class="text-center text-subtitle-1 font-weight-black">Zahn/Gebiet</th>
                <th class="text-center text-subtitle-1 font-weight-black">Anzahl</th>
                <th class="text-center text-subtitle-1 font-weight-black">Betrag EUR</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(data, index) in tableData" :key="index">
                <td class="text-center">{{data.subsidy}}</td>
      ...
      <!-- <div v-if="!calculated" class="ubernehmen d-flex flex-column">
        <span>Hinweis: 11f,12ww,13-15ww...</span>
        <span class="text-justify">Nummern und Fundstatus-Shortcuts sollten gültig sein. Die gültigen Nummern werden durch Überfahren des Zahnsymbols gefunden und gültige Fundkürzel werden im Info-Link angezeigt.</span>
      </div> -->
...
<script>
  ...
  import UpperJaw from '../components/UpperJaw.vue'
  import Mandible from '../components/Mandible.vue'
  import TeethNumbers from '../components/TeethNumbers.vue'
  ...
  // import Logo from '@/assets/festzuschuss.online.svg'
    ...
    methods: {
      ...
      apiCall() {
        if((this.rules.validEntry(this.findingsEntries) || this.errorMsg) && (this.findingsEntries || !this.invalidEntries)) {
          ...
          this.calculateValuesApi(input, this.decryptedId).then((response) => {
